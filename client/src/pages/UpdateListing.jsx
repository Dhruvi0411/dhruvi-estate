        ...
        <div className="p-3 max-w-4xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-4" onSubmit={formSubmitHandler}>
                <div className="flex flex-col gap-4 flex-1">
                    <input type="text" onChange={changeHandler} value={formData.name} placeholder="Name" className="border p-3 rounded-lg" id="name" maxLength="62" minLength="10" required></input>
                    <textarea type="text" onChange={changeHandler} value={formData.description} placeholder="Description" className="border p-3 rounded-lg" id="description" required></textarea>
                    <input type="text" onChange={changeHandler} value={formData.address} placeholder="Address" className="border p-3 rounded-lg" id="address" required></input>
                    <div className="flex gap-6 flex-wrap">
                        <div className="flex gap-2">
                            <input type="checkbox" id="sale" className="w-5" onChange={changeHandler} checked={formData.type === 'sale'}></input>
                            <span>Sale</span>
                        </div>
                        <div className="flex gap-2">
                    ...
                    <div className="flex flex-wrap gap-6">
                        <div className="flex items-center gap-2">
                            <input type="number" id="bedrooms" onChange={changeHandler} value={formData.bedrooms} min="1" max="10" className="p-3 border border-gray-300 rounded-lg" required></input>
                            <p>Beds</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <input type="number" id="bathrooms" onChange={changeHandler} value={formData.bathrooms} min="1" max="10" className="p-3 border border-gray-300 rounded-lg" required></input>
                            <p>Baths</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <input type="number" id="regularPrice" onChange={changeHandler} value={formData.regularPrice} min="50" max="1000000" className="p-3 border border-gray-300 rounded-lg" required></input>
...

                        {
                            formData.offer === true ? (
                                <div className="flex items-center gap-2">
                                    <input type="number" id="discountPrice" onChange={changeHandler} value={formData.discountPrice} min="10" max="1000000" className="p-3 border border-gray-300 rounded-lg" required></input>
                                    <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">{loading ? "Updateing....." : "Update Listing"}</button>
