      ...
      <form className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            <input type="file" id="images" className="p-3 border border-gray-300 rounded w-full" accept="image/*" multiple></input>
            <button className="p-3 text-green-700 rounded border border-green-700 hover:bg-green-700 hover:text-white hover:duration-700 hover:shadow-lg">Upload</button>
          </div>
